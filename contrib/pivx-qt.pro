...
RESOURCES += src/qt/recur.qrc src/qt/recur_locale.qrc

TRANSLATIONS += src/qt/locale/recur_bg.ts \
                src/qt/locale/recur_de.ts \
                src/qt/locale/recur_en.ts \
                src/qt/locale/recur_es.ts \
                src/qt/locale/recur_fi.ts \
                src/qt/locale/recur_fr.ts \
                src/qt/locale/recur_it.ts \
                src/qt/locale/recur_ja.ts \
                src/qt/locale/recur_pl.ts \
                src/qt/locale/recur_pt.ts \
                src/qt/locale/recur_ru.ts \
                src/qt/locale/recur_sk.ts \
                src/qt/locale/recur_sv.ts \
                src/qt/locale/recur_vi.ts \
                src/qt/locale/recur_zh_CN.ts \
                src/qt/locale/recur_zh_TW.ts
