...
if [[ ! -e "autogen.sh" ]]
then
    echo "autogen.sh is not found, not root directory of RecurPay repository?"
    exit 1
fi
...
if [[ ! -e "src/recur-cli" ]]
then
    echo "recur-cli was not found"
    exit 1
fi

if [[ ! -e "src/recur-tx" ]]
then
    echo "recur-tx was not found"
    exit 1 
fi

if [[ ! -e "src/recurd" ]]
then
    echo "recurd was not found"
    exit 1 
fi

if [[ ! -e "src/qt/recur-qt" ]]
then
    echo "recur-qt was not found"
    exit 1 
fi
