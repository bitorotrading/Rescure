...
This means one can have an always-on recurd instance running, and another local recurd/recur-qt instance which connects to this node and receives blocks from it.
