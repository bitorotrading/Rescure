...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<recur_address\> \<monthly_payment_recur\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ RECUR, _12_ times over the course of a year totaling _24000_ RECUR.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<recur_address\> \<monthly_payment_recur\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` RECUR.
