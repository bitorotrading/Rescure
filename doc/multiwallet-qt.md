...
In order to support loading of multiple wallets in recur-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is recur.cpp.
...
Changes to recur.cpp
----------------------
recur.cpp is the entry point into recur-qt, and as such, will require some minor modifications to provide hooks for
