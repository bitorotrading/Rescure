...
// Copyright (c) 2017 The RecurPay developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("000000cbed116ea9f8d877e8525ecdc13306bfd6f86a0bfcaa92cfbf7f6ba5f0"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1533974418, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 51579;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // RecurPay starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 120; // RecurPay: 2 minute
        nTargetSpacing = 1 * 120;  // RecurPay: 2 minute
        nPastBlocksMin = 24;
        nLastPOWBlock = 10080;
        nMaturity = 90;
         ...
         *   vMerkleTree: e0028e
         */
        const std::string pszTimestamp = "Recur Pay has been created on August 11th 2018";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1533974418;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2122383;
...
//         printf("Gensis Hash Merkle: %s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        assert(hashGenesisBlock == uint256("0x000000cbed116ea9f8d877e8525ecdc13306bfd6f86a0bfcaa92cfbf7f6ba5f0"));
        assert(genesis.hashMerkleRoot == uint256("0xba86b1f1de988e8a69f4079f012c0386b00763f28cfd1e57813534b296665ed4"));

   //     vSeeds.push_back(CDNSSeedData("recur", "seed.recurpay.org"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // RecurPay: 1 day
        nTargetSpacing = 1 * 60;  // RecurPay: 1 minute
        nPastBlocksMin = 200;
        nLastPOWBlock = 10080;
        nMaturity = 15;
...
//         printf("Gensis Hash Merkle: %s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet recur addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet recur script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet recur BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet recur BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet recur BIP44 coin type is '1' (All coin's testnet default)
...
//             printf("genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str());
//         printf("Gensis Hash Merkle: %s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("784b1c309f3c83c9a560ddc73a7adbd9794575304eb1ddb211cdd6e88b66eec7"));
