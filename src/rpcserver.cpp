...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"recur", "masternode", &masternode, true, true, false},
        {"recur", "masternodelist", &masternodelist, true, true, false},
        {"recur", "mnbudget", &mnbudget, true, true, false},
        {"recur", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"recur", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"recur", "mnsync", &mnsync, true, true, false},
        {"recur", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"recur", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use recurd, or the -server option to recur-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> recur-cli " + methodname + " " + args + "\n";
}
