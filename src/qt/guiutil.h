...
/** Utility functions used by the RecurPay Qt UI.
 */
namespace GUIUtil
{
...
// Render RecurPay addresses in monospace font
...
// Parse "recur:" URI into recipient object, return true on successful parsing
