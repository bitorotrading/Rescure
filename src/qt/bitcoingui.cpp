                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("RecurPay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RecurPay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and recur: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About RecurPay Core"), this);
    aboutAction->setStatusTip(tr("Show information about RecurPay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for RecurPay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RecurPay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RecurPay addresses"));
    ...
    openAction->setStatusTip(tr("Open a RecurPay: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the RecurPay Core help message to get a list with possible RecurPay command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("RecurPay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RecurPay network", "", count));
}
...
{
    QString strTitle = tr("RecurPay Core"); // default title
