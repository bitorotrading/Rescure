...
#if defined(NDEBUG)
#error "RECUR cannot be compiled without assertions."
#endif
...
{
    /**
     * Block 1: 12 Billions RECUR pre-mined
     Block Reward:
     Blocks 2 - 151,200 - 2500 RECUR
     Blocks 151,201 - 302,399 - 1250 RECUR
     Blocks 302,400 - Infinite:  1000 RECUR
