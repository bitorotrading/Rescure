...
The following applies to code changes to the RECUR Core project, and is not to be
confused with overall RECUR Network Protocol consensus changes.

Whether a pull request is merged into RECUR Core rests with the project merge
...
Patches that change RECUR consensus rules are considerably more involved than
...
Where a patch set proposes to change the RECUR consensus, it must have been
...
The project leader is the release manager for each RECUR Core release.
